import sys
from config import MONGO_CLIENT,CLIENT_HDFS
...
Client_hdfs=Client(CLIENT_HDFS.get('HOST'),root=CLIENT_HDFS.get('ROOT'),timeout=CLIENT_HDFS.get('TIMEOUT'),session=CLIENT_HDFS.get('SESSION'))
