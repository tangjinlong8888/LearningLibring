...
def wrtie_to_hdfs(client,hdfs_path,data,encoding='utf-8'):
    client.write(hdfs_path,data,overwrite=True,append=False,encoding=encoding)
...
Client_hdfs = Client('http://10.2.1.44:50070/',root='/',timeout=10000,session=False)
