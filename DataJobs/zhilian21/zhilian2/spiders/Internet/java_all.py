...
class JavaallSpider(scrapy.Spider):
    name = 'javaall'
    allowed_domains = ['zhaopin.com']
    #开始地址
    start_urls = ['https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Java%E5%BC%80%E5%8F%91&kt=3&_v=0.32055458&x-zp-page-request-id=57315b32968149c3a6dfd42595e68f76-1555161784631-359989'
    ]
    ...
    def parse(self, response):
        ...
        # java开发全国岗位网址
        new_url = 'https://fe-api.zhaopin.com/c/i/sou?start='+str(self.starts)+'&pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Java%E5%BC%80%E5%8F%91&kt=3&_v=0.32055458&x-zp-page-request-id=57315b32968149c3a6dfd42595e68f76-1555161784631-359989'
        # 新网址用yield返回给引擎
