...
class WeballSpider(scrapy.Spider):
    name = 'weball'
    allowed_domains = ['zhaopin.com']
    #开始地址
    start_urls = ['https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Web%E5%89%8D%E7%AB%AF&kt=3&_v=0.17188142&x-zp-page-request-id=d689d1ad08934223a26ecaec80a6ec61-1555060145678-985530'
    ]
    ...
    def parse(self, response):
        ...
        # web前端全国岗位网址
        new_url = 'https://fe-api.zhaopin.com/c/i/sou?start='+str(self.starts)+'&pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Web%E5%89%8D%E7%AB%AF&kt=3&_v=0.17188142&x-zp-page-request-id=d689d1ad08934223a26ecaec80a6ec61-1555060145678-985530'
        # 新网址用yield返回给引擎
