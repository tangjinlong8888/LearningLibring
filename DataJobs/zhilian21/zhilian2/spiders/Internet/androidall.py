...
class AndroidallSpider(scrapy.Spider):
    name = 'androidall'
    allowed_domains = ['zhaopin.com']
    #开始地址
    start_urls = ['https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Android&kt=3&_v=0.36749087&x-zp-page-request-id=1e754a0a535a4a30b9a52820c05cf38d-1555163261006-513406'
    ]
    ...
    def parse(self, response):
        ...
        # android开发全国岗位网址 start='+str(self.starts)+'&
        new_url = 'https://fe-api.zhaopin.com/c/i/sou?start='+str(self.starts)+'&pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Android&kt=3&_v=0.36749087&x-zp-page-request-id=1e754a0a535a4a30b9a52820c05cf38d-1555163261006-513406'
        # 新网址用yield返回给引擎
