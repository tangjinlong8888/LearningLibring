...
class PhpallSpider(scrapy.Spider):
    name = 'phpall'
    allowed_domains = ['zhaopin.com']
    #开始地址
    start_urls = ['https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=PHP&kt=3&_v=0.76591723&x-zp-page-request-id=d488d65b1e804c06ad7f3ec820edd798-1555162541641-108679'
    ]
    ...
    def parse(self, response):
        ...
        # PHP开发全国岗位网址
        new_url = 'https://fe-api.zhaopin.com/c/i/sou?start='+str(self.starts)+'&pageSize=90&cityId=489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=PHP&kt=3&_v=0.76591723&x-zp-page-request-id=d488d65b1e804c06ad7f3ec820edd798-1555162541641-108679'
        # 新网址用yield返回给引擎
